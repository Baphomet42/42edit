...
public class AutoClickScreen extends GenericScreen {
    ...
    protected void init() {
        ...
        paneScroll().addRow(
            WIDGET_UTIL.newButton("Use", btn -> {
                    FortytwoEdit.updateAutoClick(!FortytwoEdit.autoUse, FortytwoEdit.autoMine, FortytwoEdit.autoAttack, FortytwoEdit.autoFish, FortytwoEdit.attackWait);
                    rebuildWidgets();
                }).setBoolName(FortytwoEdit.autoUse).setRenderItem(Items.GOLDEN_APPLE).setTooltip(
    ...
    protected void setTxtAttackCooldown() {
        if (unsaved) {
            ...
            FortytwoEdit.updateAutoClick(FortytwoEdit.autoUse, FortytwoEdit.autoMine, FortytwoEdit.autoAttack, FortytwoEdit.autoFish, attackWait);
