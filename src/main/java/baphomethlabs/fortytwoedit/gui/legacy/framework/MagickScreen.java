...
public class MagickScreen extends Screen implements FTScreen {
	...
	private final MouseInputHandler<MagickScreen> mouseInputHandler = new MouseInputHandler<>(this);

	public MagickScreen(GuiDescription description) {
		this(ScreenTexts.EMPTY, description);
	}

	public MagickScreen(Text title, GuiDescription description) {
		super(title);
